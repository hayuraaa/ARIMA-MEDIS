...
if uploaded_file is not None:
    ...
    # Preprocess data
    df = df[['Produksi (Jumlah) Limbah Infeksius']]
    ...
    df_future = pd.DataFrame({
        'Produksi (Jumlah) Limbah Infeksius': [None] * len(df) + [None] * forecast_periods,
    ...
    plt.plot(df['Produksi (Jumlah) Limbah Infeksius'], label='Actual')
